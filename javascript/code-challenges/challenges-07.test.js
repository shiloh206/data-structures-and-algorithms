...
const sortStarWarsCharacters = (starWarsArr) => {
  // Solution code here...
  let sortedChars = starWarsArr.sort((a, b) => b.height - a.height);
  return sortedChars;
};
...
const listFoods = (recipe) => {
  ...
  recipe.ingredients.forEach(ingredient =>{
    let withoutAmout = ingredient.slice(ingredient.indexOf(' ')+ 1);
    let withoutUnits = withoutAmout.slice(withoutAmout.indexOf(' ')+ 1);
